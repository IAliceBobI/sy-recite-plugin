...
- **Per-item clear** — botched this one item? Hit "Clear" next to "Compare" to wipe just that answer and rewrite it — other items and context passages stay untouched
